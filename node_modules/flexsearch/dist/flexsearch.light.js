...
J.prototype.search=function(a,c,b){b||(c||"object"!==typeof a?"object"===typeof c&&(b=c):(b=a,a=b.query));let d=[],e;let h,f=0;if(b){c=b.limit;f=b.offset||0;var g=b.context;h=!1}if(a&&(a=this.encode(a),e=a.length,1<e)){b=y();var k=[];for(let m=0,r=0,p;m<e;m++)if((p=a[m])&&p.length>=this.h&&!b[p])if(this.g||h||this.i[p])k[r++]=p,b[p]=1;else return d;a=k;e=a.length}if(!e)return d;c||(c=100);g=this.j&&1<e&&!1!==g;b=0;let n;g?(n=a[0],b=1):1<e&&a.sort(z);for(let m,r;b<e;b++){r=a[b];g?(m=O(this,d,h,c,f,
2===e,r,n),h&&!1===m&&d.length||(n=r)):m=O(this,d,h,c,f,1===e,r);if(m)return m;if(h&&b===e-1){k=d.length;if(!k){if(g){g=0;b=-1;continue}return d}if(1===k)return P(d[0],c,f)}}return I(d,c,f,h)};
