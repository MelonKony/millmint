...
`url( /gfx/img/bg.jpg?q=100&auto=format )` parses to:

```js
{ type: 'function', sourceIndex: 0, value: 'url', before: ' ', after: ' ', nodes: [
    { type: 'word', sourceIndex: 5, value: '/gfx/img/bg.jpg?q=100&auto=format' }
] }
```

`url( "/gfx/img/bg.jpg?q=100&auto=format" )`, on the other hand, parses to:

```js
{ type: 'function', sourceIndex: 0, value: 'url', before: ' ', after: ' ', nodes: [
     type: 'string', sourceIndex: 5, quote: '"', value: '/gfx/img/bg.jpg?q=100&auto=format' },
] }
```
