...
Moise is brown-eyed and dark-haired, with powerful Greek features inherited from his mother and father. Hard
...
{{<section>}}
**Coretti lo Rus de Gloria Adoula** is [Moise's](/characters/moise) girlfriend
...
<div class="headerbox">
  <h1 class="title" >Baron</h1>
  <div class="emoji" id="whirlybat">7</div>
</div>

{{<section>}}
**Baron Desmoisnes**, colloquially **The Baron** behind his back, is Tzipora's adoptive father and guardian.

{{< button href="/tags/baron" >}}See all stories featuring Baron{{< /button >}}
{{</section>}}

{{< details title="Get to know Baron">}}
##### Appearance
...
<div class="headerbox">
  <h1 class="title" >Ayn</h1>
  <div class="emoji" id="whirlybat">4</div>
</div>
