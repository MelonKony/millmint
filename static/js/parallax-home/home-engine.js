...
// Remember kids: Other languages' hacked garbage is Javascript best practice!
    ...
    function fixCanvasLayout(){
        ...
        for(i=0;i<canvas_list.length;i++){
            ...
            $("#" + canvas_list[i]).attr("width", document.getElementById(canvas_list[i]).clientWidth * 2);
            $("#" + canvas_list[i]).attr("height", document.getElementById(canvas_list[i]).clientHeight * 2);
        }
