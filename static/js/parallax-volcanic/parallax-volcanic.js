...
var falling_layers = [
    ...
    new Animated_Object("falling-9",[KeyFrame(0, 0, 526), KeyFrame(910, 0, 920)], pre_ani = 'stop'),
    ...
    new Animated_Object("falling-11",[KeyFrame(0, 0, 536), KeyFrame(910, 0, 790)], pre_ani = 'stop'),
