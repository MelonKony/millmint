...
var falling_layers = [
    new Animated_Object("falling-1",[KeyFrame(0, 0, 500), KeyFrame(910, 0, 1150)], pre_ani = 'stop'),
    new Animated_Object("falling-2",[KeyFrame(0, 0, 500), KeyFrame(910, 0, 1075)], pre_ani = 'stop'),
    ...
    new Animated_Object("falling-6",[KeyFrame(0, 0, 0), KeyFrame(910, 0, 250)], pre_ani = 'stop'),
